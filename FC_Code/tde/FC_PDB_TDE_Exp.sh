...
srvctl stop database -d PRD_iad3vt
srvctl status database -d PRD_iad3vt
srvctl start database -d PRD_iad3vt
srvctl status database -d PRD_iad3vt
...
echo "Shutting down PRD for TDE export: ---- Confirm with YyEeSs(default n):"
confirm=n
read input
