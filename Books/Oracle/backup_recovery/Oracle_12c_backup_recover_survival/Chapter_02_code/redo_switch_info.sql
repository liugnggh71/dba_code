...
--- Date  : 20/07/2013
--- Script: redo_switch_info.sql
--- Description: shows you how many log switches occurred by day 
--- and hour. That information helps you easily identify 
--- common hours of overload in redo generation. It also
--- helps you spot the need to tune your redo log files 
--- size to reduce log switches
